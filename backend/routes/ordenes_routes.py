...
from controllers.ordenes_controller import listar_ordenes, obtener_orden, crear_orden, actualizar_orden, eliminar_orden, listar_talles_orden
...
ordenes_bp.route("/<int:id_orden>/talles", methods=["GET"])(listar_talles_orden)
