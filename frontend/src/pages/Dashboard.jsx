...
const secciones = {
  productos: { ruta: "/productos", endpoint: "/productos/", id: "id_producto", columnas: ["Código base", "Producto", "Color"], celdas: (item) => [String(item.articulo_producto || "").replace(/^BASE-/, "") || "-", item.nombre_producto || "-", item.color || "Sin color"] },
