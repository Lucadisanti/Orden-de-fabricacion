                  ...
                  {paginacion.pageItems.map((p) => (
                    <tr key={p.id_producto}>
                      ...
                      <td>
                        ...
                        <PermisoRegistro registro={p} soloAdmin><button className="ui-btn ui-btn-danger" onClick={() => eliminar(p.id_producto)}>
                          Eliminar
                        </button></PermisoRegistro><AutoriaRegistro registro={p} />
                      </td>
                    </tr>
                  ))}
                </tbody>
