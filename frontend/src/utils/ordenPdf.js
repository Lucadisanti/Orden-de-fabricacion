...
export function crearOrdenPdf({ orden, talles, materiales, logo }) {
  ...
  tabla("Datos de la orden", [["Producto", "Color", ...(orden.es_forrado ? ["Adicional"] : []), "Estado"]], [[valor(orden.producto), valor(orden.color), ...(orden.es_forrado ? ["Forrado"] : []), estadoLegible]]);
